...
for loop_UE_idx = 1 : BS.num_of_UE
    ...
    w_k = Users(loop_UE_idx).beam_vector_matrix(:,SC_index);
    ...
    if Users(loop_UE_idx).if_S_NOMA == 1
        ...
        for j = 1 : Partner_num_SD_NOMA
            ...
            w_j = Users(UE_j_idx).beam_vector_matrix(:,SC_index);
    ...
    if Users(loop_UE_idx).if_P_NOMA == 1 && Users(loop_UE_idx).if_Strong_UE_P_NOMA == 0
        ...
        w_UE_strong = Users(UE_strong_idx).beam_vector_matrix(:,SC_index);
    ...
    if Users(loop_UE_idx).if_P_NOMA == 1 && Users(loop_UE_idx).if_Strong_UE_P_NOMA == 1
        ...
        w_UE_weak = Users(UE_weak_idx).beam_vector_matrix(:,SC_index);
    ...
    if Users(loop_UE_idx).if_P_NOMA == 1 && Users(loop_UE_idx).if_Strong_UE_P_NOMA == 1
        u_fun(loop_UE_idx) = min(rate_ue(loop_UE_idx)/BS.rate_max, 1) - ...
            Users(loop_UE_idx).cost_weight*g_cost_cal_MATLAB(loop_UE_idx, SC_index, SINR_SIC(loop_UE_idx), 0);
    else
        u_fun(loop_UE_idx) = min(rate_ue(loop_UE_idx)/BS.rate_max, 1) - ...
            Users(loop_UE_idx).cost_weight*g_cost_cal_MATLAB(loop_UE_idx, SC_index, 0, 0);
    end
